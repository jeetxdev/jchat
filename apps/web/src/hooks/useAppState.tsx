...
export function useAppState(): AppState {
  ...
  const [chatWallpapers, setChatWallpapers] = useState<Record<string, WallpaperId>>(getChatWallpapers);
  ...
  const screens: AppScreens = {
    ...
    call: (variant) => {
      ...
      return <CallScreen chat={callChat} variant={variant} onEndCall={() => setActiveCallChatId(null)} />;
    },
  };
