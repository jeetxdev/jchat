...
export const chats: Chat[] = [
  {
    ...
    messages: [
      ...
      { id: 'm4', authorId: 'maya', image: { caption: 'Slide 4, the pricing table', heartCount: 2 }, time: '9:07' },
      { id: 'm5', authorId: 'maya', text: 'Looks great, love the blue accent on the total row', time: '9:09' },
    ],
  },
  {
    id: 'chat-jordan',
    ...
    contactId: 'jordan',
    messages: [
      { id: 'j1', authorId: 'jordan', text: 'Voice message · 0:14', time: '8:47' },
    ],
  },
  {
  ...
  },
  {
    ...
    contactId: 'amir',
    messages: [
      { id: 'a1', authorId: 'amir', text: 'Sounds good, see you then', time: 'Mon' },
    ],
  },
];
